...
public class MyPageActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        file_search= (Button) findViewById(R.id.file_search);

        file_search.setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View view){
                intent = new Intent(MyPageActivity.this, FileSearchActivity.class);
        ...
        student_info.setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View view){
                intent = new Intent(MyPageActivity.this, ChangeStudentInfoActivity.class);
                startActivity(intent);
            }
        });

        student_list = (Button) findViewById(R.id.list_student);

        student_list.setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View view){
                intent = new Intent(MyPageActivity.this, StudentActivity.class);
                startActivity(intent);
            }
        });
